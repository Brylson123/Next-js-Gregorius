    ...
    return (
        <form className="flex flex-col gap-8" onSubmit={submitHandler}>
            <label className="flex flex-col">
                <span className="mb-4 font-medium text-gray-800">{("Imię")}</span>
                <input
                    type="text"
                    name="name"
                    value={form.name}
            ...
            <label className="flex flex-col">
                <span className="mb-4 font-medium text-gray-800">{("Email")}</span>
                <input
                    type="email"
                    name="email"
                    value={form.email}
            ...
            <label className="flex flex-col">
                <span className="mb-4 font-medium text-gray-800">{("Wiadomość")}</span>
                <textarea
                    rows={8}
                    name="message"
                    value={form.message}
